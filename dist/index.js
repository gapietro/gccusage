...
function resolveTimeoutMs() {
	...
	if (!Number.isInteger(parsed) || parsed <= 0 || parsed > 2147483647) return DEFAULT_STDIN_TIMEOUT_MS;
	return parsed;
}
/**
...
//#endregion
//#region src/utils/display-width.ts
/**
...
function graphemeWidth(cluster) {
	...
	if (codePoint >= REGIONAL_INDICATOR_FIRST && codePoint <= REGIONAL_INDICATOR_LAST) return 2;
